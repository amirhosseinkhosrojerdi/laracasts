...
Route::prefix('v1')->group(function(){
    ...
    Route::prefix('/channel')->group(function(){
        Route::get('/all', 'App\Http\Controllers\API\V01\Channel\ChannelController@getAllChannelsList')->name('channel.all');
        Route::post('/create', 'App\Http\Controllers\API\V01\Channel\ChannelController@createNewChannel')->name('channel.create');
        Route::put('/update', 'App\Http\Controllers\API\V01\Channel\ChannelController@updateChannel')->name('channel.update');
        Route::delete('/delete', 'App\Http\Controllers\API\V01\Channel\ChannelController@deleteChannel')->name('channel.delete');
    });
});